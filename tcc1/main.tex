...
\usepackage{float}
\usepackage{url}
\usepackage{hyperref} % comentar este na hora de imprimir
...
Agradeço os recursos materiais e financeiros providos pela Fundação de Amparo à Pesquisa do Estado do Amazonas (FAPEAM) e pelo Conselho Nacional de Desenvolvimento Científico e Tecnológico (CNPq) por meio do Projeto FAPEAM/CNPQ PPP 04/2017.
