...
\begin{frame}{LeNet}
  ...
  \toprule
  \textbf{Arquitetura} & \textbf{Otimizador} & \textbf{\emph{Patience}}  & \textbf{Função de Ativação} & \textbf{Acurácia} & \textbf{F-Score} & \textbf{EER} \\
  \midrule
  ShuffleNet & Adam & 15 & ReLU & $0.8345$ & $0.7705$ & $23.8151$ \\
  SqueezeNet & RMSprop & 15 & ReLU & $0.8210$ & $0.7709$ & $20.1673$\\
  \bottomrule
  \end{tabular}}
  \end{table}
